...
//posArray////////////////////////////////////////////////////////////
class vertexArray : public transformable2, public multiCacher
{
protected:
...
class customPath : public transformable2, public multiCacher
{
protected:
...
//rectangle
class rectangle : public transformable2, public multiCacher
{
protected:
    vec2f position_;
    vec2f size_;
...
class text : public transformable2, public multiCacher
{
protected:
    vec2f position_ {};
    float size_ {14};
...
class circle : public transformable2, public multiCacher
{
protected:
    vec2f position_;
    float radius_;
...
//shape//////////////////////////////////////
class shape : public multiCacher
{
protected:
    mask mask_;
    brush brush_;
