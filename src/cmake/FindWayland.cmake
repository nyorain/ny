...
#
# File was edited by nyorain and does not fully match the original content.
# Added wayland-cursor to libs
...
find_library(WAYLAND_CURSOR_LIBRARIES NAMES wayland-cursor   HINTS ${PC_WAYLAND_LIBRARY_DIRS})
...
find_path(WAYLAND_CURSOR_INCLUDE_DIRS  NAMES wayland-cursor.h HINTS ${PC_WAYLAND_INCLUDE_DIRS})
...
find_package_handle_standard_args(WAYLAND_CURSOR  DEFAULT_MSG  WAYLAND_CURSOR_LIBRARIES  WAYLAND_CURSOR_INCLUDE_DIRS)
