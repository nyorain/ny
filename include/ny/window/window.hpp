...
public:
    ...
    //all backends? if useful, turn out of windowContextSettings (or? think about windowContextSettings and what is should be used for!) and put generally into WC
